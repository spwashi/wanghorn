...
export let EntityContainerDescription = props =>
    <div className="description smEntity--container--description">
            ...
            <ActiveComponent component={() => {
                return (
                    <div className="purpose">
                        ...
                        <ol>
                            <li>
                                <a href={`${getURI("dev--entities__json")}?entities`}>This application's data structures</a>
                                <ul>[ used by... ]
                                    <li>
                            ...
                            <li>
                                ...
                                {"statements which could be used to establish the MySQL tables that hold the Entity's data"}
                            </li>
                        </ol>
                    </div>
                )
