...
const EntityConfigurationPropertyMetaAttribute     =
          ({propertyMeta, onPropertyLinkTrigger}) => {
              ...
              return (
                  <ConfigurationAttribute ownerType={'entity'} attribute="propertyMeta">
...
EntityConfigurationPropertyMetaAttribute.propTypes = {
    propertyMeta: PropTypes.object
};
export default EntityConfigurationPropertyMetaAttribute;